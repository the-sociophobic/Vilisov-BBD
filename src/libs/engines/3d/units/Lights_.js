...
export default class Lowpoly extends Unit {
  ...
  animate = props => {
    ...
    this.light2.position
      .set(lightDistanceToModel * cos2, lightDistanceToModel, lightDistanceToModel * ((1 - cos2 * cos2) ** .5))
      .add(props.controls.target)
    this.light3.position
      .set(lightDistanceToModel * cos3, lightDistanceToModel, lightDistanceToModel * ((1 - cos3 * cos3) ** .5))
      .add(props.controls.target)
    this.light4.position
      .set(lightDistanceToModel * cos4, lightDistanceToModel, lightDistanceToModel * ((1 - cos4 * cos4) ** .5))
      .add(props.controls.target)
  }
